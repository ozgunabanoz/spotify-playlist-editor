        ...
        <div className="row">
          <div className="column">
            <button
              ...
              onClick={
                () => this.props.onShufflePlaylist(this.props.tracks) // send playlist to be shuffled
              }
            >
              <NavLink
                className="navLink"
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onSortPlByBpmDec: playlist =>
      dispatch(actions.sortPlByBpmDec(playlist))
  };
};

export default connect(null, mapDispatchToProps)(EditPlaylistCard);
